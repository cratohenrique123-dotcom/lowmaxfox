  ...
  ({ className, variant = "default", ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        variant === "glass" && "bg-[hsl(220,20%,8%/0.8)] backdrop-blur-xl border border-[hsl(220,20%,18%/0.5)]",
        variant === "neon" && "bg-card border border-primary/30 shadow-[0_0_10px_hsl(200,100%,50%/0.4)]",
        className
      )}
      {...props}
    />
